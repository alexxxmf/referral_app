...
# this is the python library that contains the most popular url
# shorteners from the market
# IMPORTANT NOTE: For most of them we need credentials. In this case
# tinyurl is an exception but it's better to be aware of it
...
class TooManySubscriptionsFromSameIP(Exception):
    """
    This is the exception we are going to raise once we pass
    the number of email subscriptions from the same IP. Just in
    case somebody tries to gamble the system
    """
    pass
